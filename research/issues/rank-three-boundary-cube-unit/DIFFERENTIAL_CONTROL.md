...
Formula (2.1) shows exactly what happens at an accidental scalar collision: the
logarithmic derivative acquires the relative sheet-velocity pole. Source
étaleness says the sheets themselves remain distinct as points; it does not say
one scalar function takes distinct values on them.
