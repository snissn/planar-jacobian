...
Scientific workflow:
  ...
  Read scientific-mainline-workflow/SKILL.md and its scientific review checklist before changing any claim status.
...
Operating context:
  ...
  - Do not claim that JC_2 is proved unless every load-bearing step has an independently reviewed exact proof.
...
Read in order:
  ...
  5. research/CLAIM_LEDGER.md
  6. research/tracks/filtered-equivariance.md
  7. research/leaf-packets/defect-4-staircase.md
...
Expected output on an issue-scoped feature branch:
  ...
  - an adversarial review note with ACCEPT/BLOCK disposition bound to exact commit bytes;
